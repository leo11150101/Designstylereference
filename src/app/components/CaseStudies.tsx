...
export function CaseStudies() {
  const cases = [
    { 
      title: '执法巡逻车', 
      image: "https://images.unsplash.com/photo-1596753426214-5d5198889895?auto=format&fit=crop&q=80&w=1080",
      desc: '杜绝公车私用，执法过程全程可视化，重点定时定线巡查。' 
    },
    { 
      title: '网约车与出租车', 
      image: "https://images.unsplash.com/photo-1551288049-bbda38a5f85d?auto=format&fit=crop&q=80&w=1080",
      desc: '实时轨迹监控与异常行为报警，保障司乘双方安全。' 
    },
    { 
      title: '物流运输车', 
      image: "https://images.unsplash.com/photo-1562811950-41d4a4944a4b?auto=format&fit=crop&q=80&w=1080",
    ...
    {
      title: '共享出行与微客',
      image: "https://images.unsplash.com/photo-1519003300449-424ad040507b?auto=format&fit=crop&q=80&w=1080",
      desc: '海量设备位置汇聚、低功耗通信及精细化运营分析。'
    },
    {
      title: '重型工程机械',
      image: "https://images.unsplash.com/photo-1720036236694-d0a231c52563?auto=format&fit=crop&q=80&w=1080",
      desc: '复杂工况下的设备状态回回传，实现远程诊断与预测性维护。'
    }
  ];
