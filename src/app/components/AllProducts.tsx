      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <motion.div 
            ...
            className="col-span-1 sm:col-span-2 lg:col-span-3 group relative overflow-hidden rounded-2xl border border-[#2d8cf0]/20 bg-[#2d8cf0]/[0.04] hover:bg-[#2d8cf0]/[0.07] transition-all p-8 flex items-start justify-between gap-8 cursor-pointer active:scale-[0.99]"
          >
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-4 mb-5">
                <ProductIcon name={SECTIONS[0].products[0].name} size="lg" />
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-widest text-[#2d8cf0]">设备开发</p>
                  <p className="text-lg font-semibold text-[#2d8cf0]">{SECTIONS[0].products[0].name}</p>
                </div>
              </div>
              <p className="text-sm text-zinc-500 leading-relaxed max-w-xl">{SECTIONS[0].products[0].desc}</p>
            </div>
          ...
          {/* ── 02 设备接入 ── */}
          <motion.div variants={cardVariants} className="col-span-1 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col gap-5 hover:border-[#2d8cf0]/30 transition-all active:scale-[0.98]">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-[#2d8cf0] leading-none select-none">02</span>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#2d8cf0]">{SECTIONS[1].title}</p>
            </div>
            <div className="flex flex-col gap-4">
              {SECTIONS[1].products.map((p) => (
                <div key={p.name} className="group/item flex items-start gap-3 cursor-pointer">
                  <ProductIcon name={p.name} />
                  <div>
                    <p className="text-sm font-semibold text-zinc-800 group-hover/item:text-[#2d8cf0] transition-colors">{p.name}</p>
          ...
          <motion.div variants={cardVariants} className="col-span-1 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col gap-5 hover:border-[#2d8cf0]/30 transition-all active:scale-[0.98]">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-[#2d8cf0] leading-none select-none">03</span>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#2d8cf0]">{SECTIONS[2].title}</p>
            </div>
            <div className="flex flex-col gap-4">
              {SECTIONS[2].products.map((p) => (
                <div key={p.name} className="group/item flex items-start gap-3 cursor-pointer">
                  <ProductIcon name={p.name} />
                  <div>
                    <p className="text-sm font-semibold text-zinc-800 group-hover/item:text-[#2d8cf0] transition-colors">{p.name}</p>
          ...
          <motion.div variants={cardVariants} className="col-span-1 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col gap-5 hover:border-[#2d8cf0]/30 transition-all active:scale-[0.98]">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-[#2d8cf0] leading-none select-none">04</span>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#2d8cf0]">{SECTIONS[3].title}</p>
            </div>
            <div className="flex flex-col gap-4">
              {SECTIONS[3].products.map((p) => (
                <div key={p.name} className="group/item flex items-start gap-3 cursor-pointer">
                  <ProductIcon name={p.name} />
                  <div>
                    <p className="text-sm font-semibold text-zinc-800 group-hover/item:text-[#2d8cf0] transition-colors">{p.name}</p>
          ...
          <motion.div 
            variants={cardVariants}
            className="col-span-1 sm:col-span-2 rounded-2xl border border-[#2d8cf0]/15 bg-[#2d8cf0]/[0.04] p-6 flex flex-col gap-5 hover:bg-[#2d8cf0]/[0.06] transition-all active:scale-[0.99]"
          >
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black leading-none select-none text-[#2d8cf0]">05</span>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#2d8cf0]">{SECTIONS[4].title}</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {SECTIONS[4].products.map((p) => (
                <div key={p.name} className="group/item rounded-xl border border-[#2d8cf0]/10 bg-white hover:border-[#2d8cf0]/30 transition-all p-4 cursor-pointer shadow-sm">
                  <div className="mb-3">
                    <ProductIcon name={p.name} />
                  </div>
                  <p className="text-sm font-semibold text-zinc-800 mb-1 group-hover/item:text-[#2d8cf0]">{p.name}</p>
          ...
          <motion.div variants={cardVariants} className="col-span-1 rounded-2xl border border-zinc-200 bg-white p-6 flex flex-col gap-5 hover:border-[#2d8cf0]/30 transition-all active:scale-[0.98]">
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-[#2d8cf0] leading-none select-none">06</span>
              <p className="text-xs font-semibold uppercase tracking-widest text-[#2d8cf0]">{SECTIONS[5].title}</p>
            </div>
            <div className="flex flex-col gap-4">
              {SECTIONS[5].products.map((p) => (
                <div key={p.name} className="group/item flex items-start gap-3 cursor-pointer">
                  <ProductIcon name={p.name} />
                  <div>
                    <p className="text-sm font-semibold text-zinc-800 group-hover/item:text-[#2d8cf0] transition-colors">{p.name}</p>
